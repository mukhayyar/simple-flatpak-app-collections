...
APP_ID = "com.pens.PasswordGenerator"
FIELDS = [("Length", "16"), ("How many", "5")]

def compute(vals):
    length = max(4, min(128, int(vals[0])))
    count = max(1, min(50, int(vals[1])))
    ...
    return "\n".join(out) + "\n\n~{:.0f} bits of entropy each".format(bits)
