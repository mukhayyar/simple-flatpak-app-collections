...
APP_ID = "com.pens.RockPaperScissors"
FIELDS = [("Your move (rock / paper / scissors)", "rock")]
_BEATS = {"rock": "scissors", "paper": "rock", "scissors": "paper"}

def compute(vals):
    you = vals[0].strip().lower()
    if you not in _BEATS:
        return "Type one of: rock, paper, scissors"
    cpu = random.choice(list(_BEATS))
    if you == cpu:
        res = "It's a tie!"
    elif _BEATS[you] == cpu:
        res = "You win!"
